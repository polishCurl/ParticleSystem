 ...
 *    September 8, 1992 - Creation. Provided routines InitGauss and Gauss              *
 *                        for generating Gaussian random numbers. The constant POINTS  *
 *                        defines the number of points to simulate the Brownian motion *
 *                        over.                                                        *
 *    September 1, 1994 - Modified program to work with GL graphics on the SGI         *
 *                        machines.                                                    *
 *    January 9, 1995   - Modified program to work with OpenGL graphics.               *
 *    October 9, 1996   - Changed window interface from aux to glut.                   *
 *    September 9, 1998 - Fixed a bug with Microsoft's OpenGL library that required    *
 *                        a glFlush() call in the display() function.                  *
 *    August 31, 2001   - Modified data type for geometry to float, to                 *
 *                        improve efficiency of OpenGL rendering.                      *
 ***************************************************************************************/
